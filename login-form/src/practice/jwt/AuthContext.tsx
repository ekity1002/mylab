...
// ヒント: user, token, isLoading, login, logoutを含むインターフェース
...
export const AuthProvider = ({ children }: AuthProviderProps) => {
  // TODO: user, token, isLoadingのstateを定義してください

  // TODO: useEffectで初回マウント時にトークンをチェックしてください
  // 要件:
  // 1. checkToken()を呼び出す
  // 2. 成功時はsetUser()とsetToken()で情報を設定
  ...
  // 要件:
  // 1. logoutWithJWT()を呼び出す
  // 2. setUser(null)とsetToken(null)で情報をクリア
